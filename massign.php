...
$sql = "SELECT id,firstName,dept,manCat,IdManager from `employee`,`managertable` WHERE employee.dept=managertable.manCat order by employee.firstName";
    ...
    <header>
        <nav>
            ...
            <ul id="navli">
				...
				<li><a class="homeblack" href="mviewemp.php?id=<?php echo $idd;?>">Листа на вработени</a></li>
				<li><a class="homered" href="massign.php?id=<?php echo $idd;?>">Нова Задача</a></li>
				<li><a class="homeblack" href="massignproject.php?id=<?php echo $idd?>">Задачи</a></li>
				<li><a class="homeblack" href="msalaryemp.php?id=<?php echo $idd;?>">Плати</a></li>
				<li><a class="homeblack" href="mempleave.php?id=<?php echo $idd;?>">Слободни денови</a></li>
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="massignp.php" method="POST" enctype="multipart/form-data">
					 
							<select class="form-select" id="names" name="names"><option>Работник</option>
							<?php while($res = mysqli_fetch_assoc($result)){
							if($idd == $res['IdManager']){
								$names = $res['firstName'];
								$id=$res['id'];
