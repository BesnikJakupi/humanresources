...
$idmanCat = (isset($_GET['manCat']) ? $_GET['manCat'] : '');
...
window.location.href='massignproject.php?id={$idmanCat}';
    </SCRIPT>");
  ...
  <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Поени на задача</h2>
                    <form id = "registration" action="managerMark.php" method="POST">
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" type="submit" name="update">Додај</button>
                        </div>
