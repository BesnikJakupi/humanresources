  ...
  <header>
    <nav>
      ...
      <ul id="navli">
        ...
        <li><a class="homered" href="myprofile.php?id=<?php echo $id?>"">Мој профил</a></li>
  ...
  <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Мои податоци</h2>
                    <form method="POST" action="myprofileup.php?id=<?php echo $id?>" >
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green"  name="send" >Ажурирај информации</button>
                        </div>
