...
$result = mysqli_query($conn, "UPDATE `employee_leave` SET `reason`='$reason',`start`='$editstart',`end`='$editend' WHERE token=$token");
	...
	<header>
		...
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="empproject.php?id=<?php echo $id?>">Mои задачи</a></li>
				<li><a class="homered" href="applyleave.php?id=<?php echo $id?>">Аплицирај за слободни денови</a></li>
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Промена на слободни денови</h2>
