	...
	<header>
		...
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homered" href="applyleave.php?id=<?php echo $id?>"">Слободни денови</a></li>
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Аплицирај за слободни денови</h2>
                    <form action="process/applyleaveprocess.php?id=<?php echo $id?>" method="POST">


                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Причина" name="reason">
                        </div>
